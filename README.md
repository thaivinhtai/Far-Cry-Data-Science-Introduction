...
| Name                                              | Code                                                  | Photo                                                     |
| ------------------------------------------------- | ----------------------------------------------------- | --------------------------------------------------------- |
| Machete                                           | `Machete`                                             | ![](Images/farcry_weapon_machete.png)                     |
| Jungle Falcon                                     | `Falcon`                                              | ![](Images/farcry_weapon_jungle-falcon.png)               |
| Jackhammer Shotgun                                | `Shotgun`                                             | ![](Images/farcry_weapon_jackhammer-shotgun.png)          |
| P90 SMG                                           | `P90`                                                 | ![](Images/farcry_weapon_p90-smg.png)                     |
| MP5 SMG                                           | `MP5`                                                 | ![](Images/farcry_weapon_mp5-smg.png)                     |
| M4 Carbine                                        | `M4`                                                  | ![](Images/farcry_weapon_m4-carbine.png)                  |
| AG36 Assault Rifle                                | `AG36` for the rifle, `AG36Grenade` for the explosive | ![](Images/farcry_weapon_ag36-assault-rifle.png)          |
| OICW Advanced Assault Rifle                       | `OICW` for the rifle, `OICWGrenade` for the explosive | ![](Images/farcry_weapon_oicw-advanced-assault-rifle.png) |
| AW50 Sniper Rifle                                 | `SniperRifle`                                         | ![](Images/farcry_weapon_aw50-sniper-rifle.png)           |
| M249 SAW MG                                       | `M249`                                                | ![](Images/farcry_weapon_m249-saw-mg.png)                 |
| Rocket Launcher                                   | `Rocket`                                              | ![](Images/farcry_weapon_rocket-launcher.png)             |
| Grenade                                           | `HandGrenade`                                         | ![](Images/farcry_weapon_grenade-mk2.jpg)                 |
| Mk.19 Mounted Mortar Launcher Platform            | `StickyExplosive`                                     | ![](Images/farcry_weapon_mortar.jpg)                      |
| Patrol Boat (when a player runs over another)     | `Boat`                                                | ![](Images/farcry_vehicle_patrol-boat.jpg)                |
| Humvee or Buggy (when a player runs over another) | `Vehicle`                                             | ![](Images/farcry_vehicle_buggy.png)                      |
| Rocket Launcher mounted on a vehicle              | `VehicleMountedRocketMG`                              | ![](Images/farcry_vehicle_humvee.png)                     |
| Mounted Minigun                                   | `VehicleMountedAutoMG`, `MG`                          | ![](Images/farcry_weapon_vulcan-minigun.jpg)              |
| Machine Gun mounted on a vehicle                  | `VehicleMountedMG`                                    | ![](Images/farcry_vehicle_buggy.png)                      |
| Rocket Launcher mounted on a vehicle              | `VehicleRocket`                                       | ![](Images/farcry_vehicle_humvee.png)                     |
...
| ------------------------------------------ | ----------------------------------------------- |
| ![](Images/farcry_game_session_launch.png) | ![](Images/farcry_game_session_map_loading.png) |
...
![Far Cry Frag History Spreadsheet](Images/farcry_frag-history_spreadsheet.png)
...
![Google Sheets Distinct Players](Images/farcry_google_sheets_distinct_players.jpg)
...
![Google Sheets Row Expansion Issue](Images/farcry_google_sheets_array_issue.png)
...
![Far Cry Match Statistics](Images/farcry_google_sheets_match_statistics.png)
...
![CSV File Import](Images/farcry_google_sheets_import_csv_file.png)
...
![Far Cry Match Statistics Sheet](Images/farcry_google_sheets_match_statistics_sheet_01.png)
...
| ---------------------------------------------------------- | -------------------------------------------------------------- |
| ![](Images/farcry_google_sheets_frag_history_sheet_02.png) | ![](Images/farcry_google_sheets_match_statistics_sheet_02.png) |
...
![Far Cry Match Overall Statistics](Images/farcry_google_sheets_match_statistics_sheet_03.png)

---

![](Images/farcry_wallpaper_02.jpg)
...
![Far Cry Entity Diagram Design](Images/farcry_erd_initial.png)
...
| ------------------------------------------------------------ | ------------------------------------------------------------------ |
| ![](Images/farcry_erd_entity_match_frag_edition_initial.png) | ![](Images/farcry_erd_entity_match_statistics_edition_initial.png) |
...
![Match Entity Edition](Images/farcry_erd_entity_match.png)
...
![Entity Match Design](Images/farcry_erd_entity_match_edition.png)
...
![Entity Match Frag Final Design](Images/farcry_erd_entity_match_frag_edition_final.png)
...
| ---------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------- |
| ![Entities Relationship Edition](Images/farcry_erd_entities_match_and_match_frag_relationship_edition.png) | ![Entities Relationship Diagram](Images/farcry_erd_entities_match_and_match_frag_relationship.png) |
...
![ERD Cardinality Notation](Images/erd_cardinality_notation.jpg)
...
![Entity Cardinality Edition](Images/farcry_erd_entities_match_and_match_frag_cardinality_edition.png)
...
![Entity Relationship Diagram Final](Images/farcry_erd_final.png)
...
![](Images/farcry_wallpaper_03.jpg)
...
![SQLite Table Match](Images/farcry_sqlite_table_match_edition.png)
...
![Far Cry SQLite Database Structure](Images/farcry_sqlite_database_structure_initial.png)
...
![Table Match Frag Foreign Key Edition](Images/farcry_sqlite_table_match_frag_foreign_key_edition.png)
...
![Table Match Data Browsing](Images/farcry_sqllite_table_match_data_browsing.png)
...
![Tabe Match Frag Data Browsing](Images/farcry_sqllite_table_match_frag_data_browsing.png)

---

![](Images/farcry_wallpaper_04.jpg)
...
![SQLite CLI](Images/farcry_sqlite_cli_introduction.png)
...
![Versatile Killer](Images/farcry_statistics_versatile_killer.jpg)
...
|                                                 | Class      | Weapons                                                                                                                                                                                 |
| ----------------------------------------------- | ---------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ![Hitman](Images/farcry_class_hitman.png)              | Hitman     | `Machete`, `Falcon`, `MP5`                                                                                                                                                              |
| ![Sniper](Images/farcry_class_sniper.png)              | Sniper     | `SniperRifle`                                                                                                                                                                          |
| ![Commando](Images/farcry_class_commando.jpg)          | Commando   | `AG36`, `OICW`, `P90`, `M4`, `Shotgun`, `M249`                                                                                                                                          |
| ![Psychotic Killer](Images/farcry_class_psychotic.jpg) | Psychopath | `Rocket`, `VehicleRocket`, `HandGrenade`, `StickExplosive`, `Boat`, `Vehicle`, `VehicleMountedRocketMG`, `VehicleMountedAutoMG`, `MG`, `VehicleMountedMG`, `OICWGrenade`, `AG36Grenade` |
...
![Serial Killer](Images/farcry_statistics_serial_killer.jpg)
...
![Serial Loser](Images/farcry_statistics_serial_loser.png)
...
![Lucky Luke Killer](Images/farcry_statistics_lucky_luke_killer.jpg)
